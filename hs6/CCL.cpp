    ...
    : spu::module::Stateful(), ccl_data(ccl_data) 
{
    ...
    // input socket
    size_t si_data_IB = create_2d_sck_in<uint8_t>(t, "in_IB", (ccl_data->i1 - ccl_data->i0), (ccl_data->j1 - ccl_data->j0)); 
    // output socket
    size_t so_data_L1 = create_2d_sck_out<uint32_t>(t, "out_L1", (ccl_data->i1 - ccl_data->i0), (ccl_data->j1 - ccl_data->j0)); 
    size_t so_data_n_RoIs = create_sck_out<int>(t, "out_n_RoIs", 1);
    ...
    create_codelet(t, 
        ...
        (Module &m, spu::runtime::Task &tsk, size_t frame) -> int 
        {
            ...
            int* n_RoIs_out = tsk[so_data_n_RoIs].get_dataptr<int>();

...
EXTERN int blur2_do_tile_urrot2_mipp_div9_f32 (int x, int y, int width, int height) {
  ...
  mipp::Reg<float32_t> r_sumf_l_l, r_sumf_l_h, r_sumf_h_l, r_sumf_h_h;
  ...
  for (int i = y + 1; i < y + height - 1; i++) {
   // #############################################################
     ...
     */ 
    {
      r_c_0_l_0_u8 = &cur_img(i - 1, x);
      r_c_0_l_1_u8 = &cur_img(i + 0, x);
      r_c_0_l_2_u8 = &cur_img(i + 1, x);
      
      r_c_1_l_0_u8 = &cur_img(i - 1, x + 1);
      r_c_1_l_1_u8 = &cur_img(i + 0, x + 1);
      r_c_1_l_2_u8 = &cur_img(i + 1, x + 1);
    ...
    for (int j = x + 1; j < x + width; j+=4) {
       ...
       */
      r_c_2_l_0_u8 = &cur_img(i - 1, j + 4); // [[ r1 g1 b1 a1 ] [r2 g2 b2 a2] [r3 g3 b3 a3] [ r4 g4 b4 a4 ]]
      r_c_2_l_1_u8 = &cur_img(i + 0, j + 4);
      r_c_2_l_2_u8 = &cur_img(i + 1, j + 4);
      ...
      r_sumf_l_l = mipp::cvt<uint32_t, float32_t>(r_sum_l_l);
      r_sumf_l_h = mipp::cvt<uint32_t, float32_t>(r_sum_l_h);
      r_sumf_h_l = mipp::cvt<uint32_t, float32_t>(r_sum_h_l);
      r_sumf_h_h = mipp::cvt<uint32_t, float32_t>(r_sum_h_h);
      ...
      r_sum_l_l = mipp::cvt<float32_t, uint32_t>(r_sumf_l_l);
      r_sum_l_h = mipp::cvt<float32_t, uint32_t>(r_sumf_l_h);
      r_sum_h_l = mipp::cvt<float32_t, uint32_t>(r_sumf_h_l);
      r_sum_h_h = mipp::cvt<float32_t, uint32_t>(r_sumf_h_h);

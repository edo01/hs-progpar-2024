...
do 
    ...
    do
        ...
        CA52_0=$(taskset -c 0 ./bin0/easypap -k blur --no-display --load-image images/1024.png -i 100 -v seq -wt $KERNEL 2>&1| tail -1)

        echo "D2_0: $D2_0 ms" >&2
        echo "CA52_0: $CA52_0 ms" >&2
        ...
        then
            CA52[0]=$CA52_0
            echo "update CA52_0" >&2
        fi

        # O1
        D2_1=$(taskset -c 1 ./bin1/easypap -k blur --no-display --load-image images/1024.png -i 100 -v seq -wt $KERNEL 2>&1| tail -1)
        echo "D2_1: $D2_1 ms" >&2
        CA52_1=$(taskset -c 0 ./bin1/easypap -k blur --no-display --load-image images/1024.png -i 100 -v seq -wt $KERNEL 2>&1| tail -1)
        echo "CA52_1: $CA52_1 ms" >&2
        ...
        then
            CA52[1]=$CA52_1
            echo "update CA52_1" >&2
        fi

        # O2
        D2_2=$(taskset -c 1 ./bin2/easypap -k blur --no-display --load-image images/1024.png -i 100 -v seq -wt $KERNEL 2>&1| tail -1)
        echo "CA52_2: $CA52_2 ms" >&2
        CA52_2=$(taskset -c 0 ./bin2/easypap -k blur --no-display --load-image images/1024.png -i 100 -v seq -wt $KERNEL 2>&1| tail -1)
        echo "D2_2: $D2_2 ms" >&2
        ...
        then
            CA52[2]=$CA52_2
            echo "update CA52_2" >&2
        fi

        ## O3
        D2_3=$(taskset -c 1 ./bin3/easypap -k blur --load-image images/1024.png -i 100 -v seq -wt $KERNEL 2>&1| tail -1)
        echo "D2_3: $D2_3 ms" >&2
        CA52_3=$(taskset -c 0 ./bin3/easypap -k blur --load-image images/1024.png -i 100 -v seq -wt $KERNEL 2>&1| tail -1)
        echo "CA52_3: $CA52_3 ms" >&2
